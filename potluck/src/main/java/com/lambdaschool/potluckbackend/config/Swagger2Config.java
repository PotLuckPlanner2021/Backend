...
public class Swagger2Config
{
    ...
    public Docket api()
    {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                              .basePackage("com.lambdaschool.potluckbackend"))
    ...
    {
        return new ApiInfoBuilder().title("PotLuckBackend Endpoints")
                .description("A Project Used to Introduce Swagger Documentation")
                .contact(new Contact("Bhawnish Kumar & Robert Rodriguez ",
